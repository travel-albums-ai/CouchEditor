...
export default function InvertNode({ id } : { id: string }) {
  const { t } = useTranslation();

  return <>
    <InputHandle id="image" />
    <NodeWrapper type="invert"
      tools={<PipelineStageTiming nodeId={id} nodeType={'invert'} />}
      helper={<BeforeAfter image2style={{ filter: `invert(1)` }} />}>
